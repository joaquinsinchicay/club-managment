...
### C. Edición de movimiento durante jornada abierta
...
- El modal de edición debe precargar valores, mostrar `movement_display_id` y fecha como read-only, y mantener read-only las referencias técnicas derivadas si existen.
