...
import { canAccessTreasuryPayrollReports } from "@/lib/domain/authorization";
...
/**
 * US-48 · Mirror read-only de los reportes RRHH para rol Tesorería.
 *
 * Reusa `getHrReport` (con guard `canViewHrReports` que admite RRHH o
 * Tesorería) y el endpoint de export `/api/rrhh/reports/export` (mismo
 * guard via service). La UI es una copia 1:1 de `/rrhh/reports/page.tsx`
 * cambiando solo el back-link a `/treasury`. Patrón "vistas paralelas"
 * acordado en plan de Fase 4 (CLAUDE.md mantiene /rrhh exclusivo de
 * rol RRHH).
 */
...
export default async function TreasuryPayrollReportsPage({
  searchParams,
}: {
  ...
  if (!canAccessTreasuryPayrollReports(context.activeMembership)) redirect("/treasury");
  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-6 sm:py-8">
      <PageContentHeader
        ...
        actions={
          <LinkButton href="/treasury" variant="secondary" size="sm">
        ...
        <Card padding="comfortable">
          ...
          <CardBody>
            ...
            <div className="mt-4 flex flex-wrap justify-end gap-2">
              ...
              <LinkButton href="/treasury/reports/payroll" variant="secondary">
