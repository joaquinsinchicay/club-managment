...
begin
  ...
  -- Seeding opcional de app.current_club_id; si está, lo usamos para enforcement.
  begin
  ...
  -- Derivar club desde el staff_member (source of truth si app.current_club_id no viene seteado).
  ...
  -- Si el club_id contextual viene seteado, exigir que coincida con el del colaborador.
  ...
  -- La estructura debe pertenecer al mismo club.
