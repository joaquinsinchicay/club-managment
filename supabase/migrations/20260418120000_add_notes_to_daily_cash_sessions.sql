-- Add notes column to daily_cash_sessions for storing closing observations
alter table daily_cash_sessions add column if not exists notes text;

-- Replace close RPC to accept optional notes
